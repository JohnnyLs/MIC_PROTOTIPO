...
-- Tabla de administradores (independiente, sin relación con tbl_usuario)
...
-- Tabla de jugadores (independiente, sin relación con tbl_usuario)
...
-- Insertar preguntas
INSERT INTO tbl_pregunta (texto_pregunta, opciones, respuesta_correcta, dificultad, tiempo_limite, categoria, costo_energia)
VALUES 
('¿Cuál es el área de un triángulo con base 4 y altura 3?', '["6", "12", "8"]', '6', 'Fácil', 30, 'aritmética', 20),
('¿Cuánto es 5 + 3 * 2?', '["11", "16", "13"]', '11', 'Medio', 20, 'aritmética', 20),
('¿Cuál es el perímetro de un cuadrado de lado 5?', '["20", "25", "15"]', '20', 'Fácil', 25, 'aritmética', 20),
('¿Cuánto es 3 x 42?', '{"a": "12", "b": "10", "c": "8", "d": "6"}', 'a', 'fácil', 5, 'multiplicación', 50),
('¿Cuánto es 5 x 6?', '{"a": "30", "b": "25", "c": "20", "d": "15"}', 'a', 'fácil', 5, 'multiplicación', 10);
